...
# Persistence baseline: "tomorrow's average AQI = today's most recent known average"
# us_aqi_rollmean_24h is already the average AQI over the past 24h at each row —
# exactly what a naive persistence forecast would use as its guess for any future day
